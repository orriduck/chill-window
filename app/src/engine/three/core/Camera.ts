...
// Portrait keeps enough projection room for the whole physical window and
// its lower journey rail, without turning the compartment into a distant
// dollhouse view.
const COMPACT_FOV = 72
